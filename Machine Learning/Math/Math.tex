...
\subsubsection{Gaussian Integral} \label{MATH_Cal_GaussianInt}
\begin{itemize}
...
\item Error Function
	...
	\end{itemize}
\end{itemize}
\subsubsection{Calculus of Variations} \label{math_calc_var}
\begin{itemize}
...
\item Univariate Gaussian
	...
	\item Expectation
		...
		\end{align*}
		note: see \hyperref[MATH_Cal_GaussianInt]{Gaussian integral} for $\int_R {\rm e}^{-x^2}\D x$
		\end{itemize}
	\item Variance
		\begin{itemize}
