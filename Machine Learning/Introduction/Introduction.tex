...
\item Artificial Data Synthesis
	...
	\item Practice
		...
		(e.g. web image classification vs. classification image uploaded by users)
		\item add canonical noise to the similar data \\ 
		(e.g. blur the web image)
		\end{itemize}
	\item Understanding
		\begin{itemize}
...
\item Low Variance, High Mismatch
	...
	\item Remedy
		...
		\item \hyperref[DL_Topic_Transfer]{transfer learning}, adaptive learning, etc.
		\end{itemize}
	\end{itemize}
