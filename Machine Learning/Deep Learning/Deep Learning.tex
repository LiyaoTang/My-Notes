...
\item SiamRPN++
	...
	\item Analysis
		...
		$\Rightarrow$ introduce \underline{central bias} \\
		(as most targets labeled in center - a wrong evidence learned to localize target)
		\item trained with shift augmentation \\ 
	...
	\item Understanding
		...
		\item deep tracker can learn central bias, due to padding \& target-centered cropping \\
		...
		$\Rightarrow$ force network to ignore response from padding
