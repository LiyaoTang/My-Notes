...
\item Understanding
	\begin{itemize}
	\item conditioned on individual data sample
	\item dynamic mechanism to spatially transform input feature map \\
	(v.s. fixed local receptive fields in pooling)
	\item NOT explicitly modeling transformation (i.e. not restricting transformation)
	\item NOT requiring additional supervision (i.e. not explicitly taking transformation in input/label)
