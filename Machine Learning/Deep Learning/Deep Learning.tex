...
\begin{itemize}
\item Fast Online Object Tracking and Segmentation : A Unifying Approach
	\begin{itemize}
	\item Input
		\begin{itemize}
...
\item Basic Image-forming Theory
	...
	\item Focal Length $F$
		...
		\includegraphics[width=0.5\linewidth, left]{"./Deep Learning/topic-rad camera focal len".jpg}
		\end{itemize}
	\item Aperture
		\begin{itemize}
	...
	\item Depth of Field (DOF) \& Depth of Focus
		...
		\includegraphics[width=0.5\linewidth, left]{"./Deep Learning/topic-rad camera dof".jpg}		
		\end{itemize}
	\item Depth of Field
		\begin{itemize}
		\item DOF as the range where $1$ pixel can hold all info from $1$ position \\
		\includegraphics[width=0.7\linewidth, left]{"./Deep Learning/topic-rad camera n and dof".png} \\
		...
		\includegraphics[width=0.7\linewidth, left]{"./Deep Learning/topic-rad camera dof and resolution".png} \\
	...
	\item Depth of Focus
		...
		\includegraphics[width=0.7\linewidth, left]{"./Deep Learning/topic-rad camera do focus".png} \\
