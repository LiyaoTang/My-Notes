...
\item Overview
	...
	\item Stacked RNN Layers
		...
		\end{itemize}
	\item RNN as Encoder-Decoder
		\begin{itemize}
		\item encoding the sequence into a vector
		\item decoding a vector into a sequence
		\end{itemize}
	\end{itemize}
\end{itemize}
...
\item Input Data
	...
	\item Sequence 
		\begin{itemize}
		\item a sequence, e.g. sentence, paragraphs
		\end{itemize}
	\end{itemize}
\item Goal
	\begin{itemize}
	\item Sequence
		\begin{itemize}
		\item a generated sequence given the task requirement \\
		(e.g. machine translation, etc.)
		\end{itemize}
	\end{itemize}
\end{itemize}
\subsubsection{Classic Approach}
