...
\item PointNet
	...
	\item Preprocessing
		...
		\end{itemize}
	\item Inference \& Structure \\
	\includegraphics[width=0.5\linewidth, center]{"./Deep Learning/plot/topic-point cloud pointnet structure".png}
		\begin{itemize}
	...
	\item Understanding
		...
		\item still, easy to lose fine geometry detail
		\end{itemize}
	\item Analysis
		\begin{itemize}
		\item point net able to mine local context by concat [point, global] feature
			\begin{itemize}
