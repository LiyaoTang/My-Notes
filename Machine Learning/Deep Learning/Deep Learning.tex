...
\item Re$^3$: Real-time Recurrent Regression Network
	...
	\item Detector
		...
		$\Rightarrow$ more descriptive (human in read/blue shirt)
		\end{itemize}
	\item Tracker
		\begin{itemize}
	...
	\item Inference
		...
		\item late fusion: concat CNN output from $t, t+1$ \& fused by dense layer (projection)
		\item tracker LSTM updates on fused
		\item dense layer regress the output at last layer for bounding box at $t+1$
		\end{itemize}
	\item Training
		\begin{itemize}
